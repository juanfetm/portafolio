<template>
 ...
 <div class="contact">
   ...
   target="_blank"><img class="Linke" src="../assets/inkedin.gif" alt="Linkedin">
    ...
    target="_blank"><img class="github" src="../assets/github.png" alt="Github"></a>
    <a href="mailto:felipemontesjt200@gmail.com"> <img class="Linke"
    src="../assets/gmail.gif" alt="gmail"></a>
